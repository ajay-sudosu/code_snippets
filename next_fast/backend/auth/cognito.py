...
def cognito_change_phone(email, new_phone):
    """change user phone in cognito"""
    try:
        logger.info(f"For {email}, changing phone to {new_phone} in cognito...")
...
def create_user_on_cognito(email: str):
    try:
        k = get_password()
...
if __name__ == '__main__':
    cognito_change_phone('xenum4u@gmail.com', '+918826006508')
