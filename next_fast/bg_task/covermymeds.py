...
class NewCoverMedsPatientFillForm:
    ...
    def new_request(self, medication):
        ...
        self.wait.until(EC.visibility_of_element_located((By.ID, "new-request"))).click()
    ...
    def check_eligibility(self):
        ...
        a.click()
        time.sleep(1)
        e = self.driver.find_element_by_class_name('eligibility')
        lis = e.find_elements_by_tag_name('li')
        button = lis[0].find_element_by_class_name('button')
        button.click()

    def patient_information(self, member_id, address1, city):
        logger.debug("Patient Info...")
        # time.sleep(5)
        patient_id_number = self.driver.find_element_by_name("patient_id_number")
        ...
        try:
            self.driver.find_element_by_partial_link_text("Check Eligibility")
    ...
    def prescriber_information(self, doctor='MARC JONATHAN SEROTA'):
        ...
        self.driver.find_element_by_xpath('//*[@id="prescriber-information-section"]/header/span[3]')
        # time.sleep(5)
        js = f"window.scrollTo(0, {self.next_y_coord});"
        self.driver.execute_script(js)
        time.sleep(2)
        button = self.driver.find_element_by_partial_link_text("Provider address book")
        button.click()
        time.sleep(2)
        try:
            prescriber_list = self.driver.find_element_by_xpath(
    ...
    def drug_information(self, drug_quantity, drug_form, drug_days_supply, primary_diagnosis):
        ...
        time.sleep(1)
        e = self.driver.find_element_by_class_name("ui-menu-item")
