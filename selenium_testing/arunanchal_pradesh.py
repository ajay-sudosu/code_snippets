...
def select_state(driver, i):
    ...
    # state = driver.find_element(By.XPATH, f"//div[@id='j_idt31_panel']/div/ul/li[3]")
    return state
...
def select_rto(driver, j):
    ...
    # rto = driver.find_element(By.XPATH, f'//*[@id="selectedRto_panel"]/div/ul/li[76]')
    return rto
...
try:
    ...
    arunanchal_pradesh = 4
    # for i in range(3, 4):
    state = select_state(driver, arunanchal_pradesh)
    time.sleep(2)
